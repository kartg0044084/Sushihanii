...
<body>
	<div id="page">
		<div id="header">
			<div id="sidebar">
				<a href="index.html" id="logo"><img src="<?php echo base_url("/public/images/logo.png"); ?>" alt="LOGO"></a>
				<div id="navigation">
					<ul>
						<li class="selected">
							<a href="<?php echo site_url('welcome/index/url')?>">Home</a>
						</li>
						<li class="menu">
							<a href="<?php echo site_url('welcome/menu/url')?>">Menu</a>
							<div class="sub">
						...
						<li>
							<a href="<?php echo site_url('welcome/blog/url')?>">Blog</a>
						</li>
						<li class="last">
							<a href="<?php echo site_url('welcome/about/url')?>">About</a>
						</li>
					</ul>
				</div>
			</div>
		...
		<div id="contents">
			<div id="articles">
				<div>
					<div class="frame">
						<img src="<?php echo base_url("/public/images/sushi9.png"); ?>" alt="Img" height="213" width="218">
						<h2>Lorem ipsum</h2>
						<p>
					...
					<div class="frame">
						<img src="<?php echo base_url("/public/images/sushi10.png"); ?>" alt="Img" height="192" width="189">
					...
					<div id="featured">
						<ul>
							<li>sushi1
								<a href="index.html"> <img src="<?php echo base_url("/public/images/sushi1.png"); ?>" alt="Img">
								<h3>Lorem Ipsum</h3>
								</a>
							</li>
							<li>
								<a href="index.html"> <img src="<?php echo base_url("/public/images/sushi2.png"); ?>" alt="Img">
								<h3>Dolor sit amet</h3>
								</a>
							</li>
							<li>
								<a href="index.html"> <img src="<?php echo base_url("/public/images/sushi3.png"); ?>" alt="Img">
								<h3>Nulla Pretium</h3>
								</a>
							</li>
							<li>
								<a href="index.html"> <img src="<?php echo base_url("/public/images/sushi4.png"); ?>" alt="Img">
								<h3>Curabitur</h3>
								</a>
							</li>
						</ul>
